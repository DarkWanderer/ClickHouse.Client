...
public class ServerTimezoneDateTimeTests : IDisposable
{
    ...
    public async Task ShouldCorrectlyDetermineServerTimezone()
    {
        ...
        ClassicAssert.AreEqual(timezone, connection.ServerTimezone);
    }
    ...
    public async Task ShouldRoundtripUnspecifiedDateTime()
    {
        ...
        ClassicAssert.AreEqual(dt, await connection.ExecuteScalarAsync(query));
    }
    ...
    public async Task ShouldReturnUTCDateTime()
    {
        ...
        ClassicAssert.AreEqual(new DateTime(2020, 11, 10, 00, 00, 00, DateTimeKind.Utc), await connection.ExecuteScalarAsync(query));
    }
}
